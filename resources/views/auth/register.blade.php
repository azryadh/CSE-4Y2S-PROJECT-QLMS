                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-primary p-4">
                                        ...
                                        <p>Get your free quickLMS account now.</p>
                                    </div>
                                </div>
                            ...
                            <div class="p-2">
                                <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="mt-4 text-center">
                                        <p class="mb-0">By registering you agree to the quickLMS <a href="javascript:void(0)" class="text-primary">Terms of Use</a></p>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <div>
                            ...
                            <p>© 2021 quickLMS. Crafted with <i class="mdi mdi-heart text-danger"></i></p>
                        </div>
                    </div>
